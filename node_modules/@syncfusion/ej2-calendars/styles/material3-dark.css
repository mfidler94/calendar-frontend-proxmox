...
.e-calendar .e-content td.e-today.e-selected span.e-day {
  background: rgba(var(--color-sf-primary));
  border: 1px solid rgba(var(--color-sf-primary));
  -webkit-box-shadow: inset 0 0 0 2px linear-gradient(0deg, rgba(var(--color-sf-primary), 0.11), rgba(var(--color-sf-primary), 0.11)), rgba(var(--color-sf-surface));
...
.e-bigger.e-calendar:not(.e-rtl) .e-header.e-year .e-title, .e-bigger.e-calendar:not(.e-rtl) .e-header.e-month .e-title,
*.e-bigger .e-calendar:not(.e-rtl) .e-header.e-year .e-title,
*.e-bigger .e-calendar:not(.e-rtl) .e-header.e-month .e-title {
  margin-left: -3px;
}
...
.e-daterangepicker.e-popup .e-footer {
  background: -webkit-gradient(linear, left bottom, left top, from(rgba(var(--color-sf-primary), 0.11)), to(rgba(var(--color-sf-primary), 0.11))), rgba(var(--color-sf-surface));
  background: linear-gradient(0deg, rgba(var(--color-sf-primary), 0.11), rgba(var(--color-sf-primary), 0.11)), rgba(var(--color-sf-surface));
  border-bottom-left-radius: calc(var(--e-radius) * 0.5);
