...
.e-split-btn-wrapper .e-split-btn:active {
  border-right-color: var(--color-sf-utility-secondary-bg-color-pressed);
}
.e-split-btn-wrapper .e-split-btn:disabled {
  border-right-color: var(--color-sf-bg-disabled);
}
...
.e-split-btn-wrapper:hover :not(e-active) .e-split-btn:disabled {
  border-right-color: var(--color-sf-border-disabled-subtle);
}
.e-split-btn-wrapper.e-rtl .e-split-btn {
...
.e-split-btn-wrapper.e-rtl .e-split-btn:active {
  border-left-color: var(--color-sf-utility-secondary-bg-color-pressed);
  border-right-color: var(--color-sf-utility-secondary-bg-color-pressed);
}
.e-split-btn-wrapper.e-rtl .e-split-btn:disabled {
  border-left-color: var(--color-sf-border-disabled-subtle);
  border-right-color: var(--color-sf-utility-secondary-border-color);
}
...
.e-split-btn-wrapper.e-vertical .e-split-btn:active {
  border-bottom-color: var(--color-sf-utility-secondary-bg-color-pressed);
  border-right-color: var(--color-sf-utility-secondary-bg-color-pressed);
}
...
*.e-flat:not(:focus).e-primary .e-progress {
  background: rgba(var(--color-sf-on-brand-solid-primary), 1);
}
*.e-flat.e-success .e-progress,
*.e-flat:not(:focus).e-success .e-progress {
  background: rgba(var(--color-sf-base-white), 1);
}
*.e-flat.e-info .e-progress,
*.e-flat:not(:focus).e-info .e-progress {
  background: rgba(var(--color-sf-utility-info-text), 1);
}
