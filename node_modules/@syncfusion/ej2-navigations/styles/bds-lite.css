...
.e-pager .e-mnext,
.e-pager .e-mlast {
  -webkit-tap-highlight-color: var(--color-sf-bg-primary);
}
.e-pager .e-pp,
.e-pager .e-np,
.e-pager .e-pp:hover,
...
.e-pager.e-rtl .e-numericitem.e-currentitem {
  border-left-color: var(--color-sf-brand-primary);
...
.e-pager .e-focused {
  -webkit-box-shadow: 0 0 0 0.5px var(--color-sf-border-primary) inset;
          box-shadow: 0 0 0 0.5px var(--color-sf-border-primary) inset;
}
...
.e-vscroll.e-rtl.e-scroll-device .e-scroll-nav.e-scroll-right-nav {
  border-color: var(--color-sf-fg-secondary);
  -webkit-box-shadow: 0 1px 3px 0 rgba(16, 24, 40, 0.1), 0 1px 2px 0 rgba(16, 24, 40, 0.06);
          box-shadow: 0 1px 3px 0 rgba(16, 24, 40, 0.1), 0 1px 2px 0 rgba(16, 24, 40, 0.06);
}
...
.e-vscroll .e-scroll-nav.e-scroll-up-nav {
  border-bottom: 1px solid var(--color-sf-fg-secondary);
}
.e-vscroll .e-scroll-nav.e-scroll-down-nav {
  border-top: 1px solid var(--color-sf-fg-secondary);
}
...
.e-toolbar {
  ...
  background: var(--color-sf-bg-secondary);
  border: 0 solid var(--color-sf-border-secondary);
  -webkit-box-shadow: none;
          box-shadow: none;
}
.e-toolbar .e-toolbar-items {
...
.e-toolbar .e-toolbar-item.e-separator {
  border: solid var(--color-sf-border-secondary);
...
.e-toolbar.e-toolpop .e-hor-nav.e-nav-active:not(.e-expended-nav) {
  ...
  -webkit-box-shadow: none;
          box-shadow: none;
  border-color: var(--color-sf-bg-secondary);
  border-style: solid;
  border-width: 0;
}
...
.e-accordion .e-acrdn-item.e-select.e-selected:first-child {
  border-top: 1px none var(--color-sf-border-secondary);
}
...
.e-accordion .e-acrdn-item .e-acrdn-panel.e-nested .e-acrdn-content .e-acrdn-item:last-child {
  border-bottom: 1px none var(--color-sf-border-secondary);
}
...
.e-carousel .e-carousel-indicators.e-default .e-indicator-bars .e-indicator-bar .e-indicator div {
  border: 1px solid rgba(var(--color-sf-base-white), 0.4);
  border-radius: 50%;
  height: 12px;
  -webkit-transition-duration: 0.6s;
          transition-duration: 0.6s;
...
.e-carousel .e-carousel-navigators .e-play-pause .e-btn:not(:disabled):hover {
  background-color: rgba(var(--color-sf-base-white), 0.4);
  outline: none;
}
...
.e-carousel .e-carousel-indicators.e-default .e-indicator-bar .e-indicator div {
  background: var(--color-sf-base-white);
...
.e-carousel .e-carousel-indicators.e-default .e-indicator-bar .e-indicator:focus-visible {
  border-color: var(--color-sf-base-black);
}
...
.e-carousel .e-carousel-indicators.e-progress .e-indicator-bars {
  background-color: rgba(var(--color-sf-brand-primary), 0.4);
}
.e-carousel .e-carousel-indicators.e-progress .e-indicator-bars .e-indicator-bar {
  background-color: var(--color-sf-brand-primary);
}
...
.e-contextmenu-container ul .e-menu-item.e-focused {
  ...
  color: var(--color-sf-text-primary);
  outline: 0 solid var(--color-sf-border-secondary);
  outline-offset: 0;
}
...
.e-contextmenu-container ul .e-menu-item.e-selected {
  background-color: var(--color-sf-bg-tertiary);
  color: var(--color-sf-text-primary);
  outline: 0 solid var(--color-sf-bg-tertiary);
  outline-offset: 0;
}
...
.e-tab .e-tab-header .e-toolbar-item .e-ripple-element {
  background: rgba(var(--color-sf-base-transparent), 0.12);
}
.e-tab .e-tab-header .e-toolbar-item .e-tab-wrap {
  border-radius: 0;
...
.e-tab .e-tab-header .e-hor-nav:not(.e-expended-nav) .e-popup-down-icon:hover {
  background: var(--color-sf-bg-tertiary);
  border: var(--color-sf-border-secondary);
  border-radius: 0;
}
.e-tab .e-tab-header .e-hor-nav .e-popup-down-icon:hover,
.e-tab .e-tab-header .e-hor-nav:not(.e-expended-nav) .e-popup-down-icon:hover {
...
.e-tab .e-tab-header.e-horizontal-bottom .e-toolbar-item.e-active {
  border-color: var(--color-sf-border-secondary) unset unset;
  border-style: solid;
  border-width: 0;
  margin-top: 0;
  border-radius: 0;
...
.e-tab .e-tab-header.e-vertical .e-scroll-nav.e-scroll-up-nav {
  border-bottom-color: rgba(var(--color-sf-bg-tertiary), 0.12);
}
.e-tab .e-tab-header.e-vertical .e-scroll-nav.e-scroll-down-nav {
  border-top-color: rgba(var(--color-sf-bg-tertiary), 0.12);
}
.e-tab .e-tab-header.e-vertical .e-scroll-nav .e-nav-arrow {
  border: 0;
}
...
.e-tab .e-tab-header.e-vertical .e-scroll-nav:hover {
  background: rgba(var(--color-sf-bg-tertiary), 0.12);
  border-color: rgba(var(--color-sf-bg-tertiary), 0.12) transparent transparent;
}
.e-tab .e-tab-header.e-vertical .e-scroll-nav:hover:active:focus {
  background: rgba(var(--color-sf-bg-secondary), 0.12);
}
...
.e-tab.e-disable .e-tab-header .e-indicator {
  background: rgba(var(--color-sf-border-secondary), 0.38);
}
...
.e-tab.e-disable .e-tab-header .e-toolbar-item.e-active .e-tab-icon {
  color: rgba(var(--color-sf-border-secondary), 0.38);
}
.e-tab.e-disable .e-content {
  opacity: 0.38;
}
.e-tab.e-fill .e-tab-header {
  border-bottom: 2px Solid var(--color-sf-border-secondary);
}
...
.e-tab.e-fill .e-tab-header .e-toolbar-item .e-ripple-element {
  background: rgba(var(--color-sf-base-transparent), 0.05);
}
.e-tab.e-fill .e-tab-header .e-toolbar-item .e-tab-wrap {
  color: var(--color-sf-text-quarterary);
}
...
.e-tab.e-fill .e-tab-header.e-horizontal-bottom {
  border-bottom: 0;
  border-top: 2px Solid var(--color-sf-border-secondary);
}
.e-tab.e-fill .e-tab-header.e-horizontal-bottom .e-toolbar-item.e-active .e-text-wrap {
  margin-top: 0;
}
...
.e-tab.e-fill .e-tab-header.e-vertical.e-vertical-left {
  border-right: 2px Solid var(--color-sf-border-secondary);
}
.e-tab.e-fill .e-tab-header.e-vertical.e-vertical-right {
  border-left: 2px Solid var(--color-sf-border-secondary);
}
...
.e-tab.e-fill.e-disable .e-tab-header {
  border-bottom: 2px Solid rgba(var(--color-sf-border-secondary), 0.38);
}
...
.e-tab.e-fill.e-disable .e-tab-header .e-toolbar-item.e-active .e-tab-wrap:focus {
  background: rgba(var(--color-sf-brand-primary), 0.38);
}
...
.e-tab.e-fill.e-disable .e-tab-header.e-horizontal-bottom {
  border-bottom: 0;
  border-top: 2px Solid rgba(var(--color-sf-border-secondary), 0.38);
}
...
.e-tab.e-fill.e-focused .e-tab-header .e-toolbar-item.e-active .e-tab-wrap:focus {
  background: rgba(var(--color-sf-bg-secondary), 0.8);
  border-color: unset;
}
...
.e-tab.e-background .e-tab-header .e-indicator {
  background: var(--color-sf-on-brand-solid-primary);
  bottom: 1px;
}
...
.e-tab.e-background .e-tab-header .e-toolbar-item .e-ripple-element {
  background: rgba(var(--color-sf-base-transparent), 0.1);
}
.e-tab.e-background .e-tab-header .e-toolbar-item .e-tab-wrap {
  background: var(--color-sf-brand-primary);
  border-color: unset;
...
.e-tab.e-background .e-tab-header .e-toolbar-item.e-active.e-itop .e-tab-wrap, .e-tab.e-background .e-tab-header .e-toolbar-item.e-active.e-ibottom .e-tab-wrap {
  background: rgba(var(--color-sf-brand-primary), 0);
}
...
.e-tab.e-background.e-focused .e-tab-header .e-toolbar-item.e-active.e-itop .e-tab-wrap:focus, .e-tab.e-background.e-focused .e-tab-header .e-toolbar-item.e-active.e-ibottom .e-tab-wrap:focus {
  background: rgba(var(--color-sf-brand-primary), 0.12);
}
...
.e-treeview .e-list-item.e-hover > .e-fullrow, .e-treeview .e-list-item.e-node-focus > .e-fullrow {
  background-color: var(--color-sf-bg-secondary-hover);
  border-color: var(--color-sf-bg-secondary-hover);
}
...
.e-treeview .e-list-item.e-active > .e-fullrow {
  ...
  border-color: var(--color-sf-utility-content-bg-color-selected);
}
...
.e-treeview .e-popup .e-downtail::before {
  border-top-color: var(--color-sf-bg-secondary-hover);
}
.e-treeview .e-popup .e-downtail::after {
  border-top-color: var(--color-sf-bg-secondary-hover);
}
...
.e-treeview.e-drag-item .e-drop-count {
  background-color: var(--color-sf-brand-primary);
  border-color: var(--color-sf-on-brand-solid-primary);
  color: var(--color-sf-on-brand-solid-primary);
}
...
/* stylelint-disable */
.e-appbar.e-light {
  border-bottom: 1px solid var(--color-sf-utility-appbar-border-color-alt1) !important;
}
.e-appbar.e-horizontal-bottom {
  border-top: 1px solid var(--color-sf-utility-appbar-border-color-alt1) !important;
}
...
.e-appbar.e-light {
  background: var(--color-sf-utility-appbar-bg-color-alt1);
  color: var(--color-sf-utility-appbar-color-alt1);
  border: var(--color-sf-utility-appbar-border-color-alt1);
  border-color: var(--color-sf-utility-appbar-border-color-alt1);
}
.e-appbar.e-light .e-appbar-separator {
  border-left: 1px solid var(--color-sf-utility-appbar-color-alt1);
}
...
.e-appbar.e-dark {
  ...
  color: var(--color-sf-utility-appbar-color-alt2);
  border-color: var(--color-sf-utility-appbar-border-color-alt2);
}
.e-appbar.e-dark .e-appbar-separator {
  border-left: 1px solid var(--color-sf-utility-appbar-color-alt2);
}
...
.e-appbar.e-dark .e-dropdown-btn.e-btn.e-inherit.e-active {
  background: var(--color-sf-utility-appbar-hover-bg-color-alt2);
}
...
.e-appbar.e-primary .e-appbar-separator {
  border-left: 1px solid var(--color-sf-on-brand-solid-primary);
}
...
.e-stepper:not(.e-steps-focus) .e-step-selected .e-step {
  -webkit-box-shadow: 0 0 0 2px var(--color-sf-bg-primary), 0 0 0 4px var(--color-sf-brand-primary), 0 0 0 8px var(--color-sf-bg-primary);
          box-shadow: 0 0 0 2px var(--color-sf-bg-primary), 0 0 0 4px var(--color-sf-brand-primary), 0 0 0 8px var(--color-sf-bg-primary);
}
...
.e-stepper .e-step-template.e-step-focus, .e-stepper:not(.e-steps-focus) :focus-visible .e-step, .e-stepper:not(.e-steps-focus) .e-step-text-only:focus-visible .e-text, .e-stepper:not(.e-steps-focus) .e-step-label-only:focus-visible .e-label {
  -webkit-box-shadow: 0 0 0 2px var(--color-sf-bg-primary), 0 0 0 4px var(--color-sf-text-primary), 0 0 0 8px var(--color-sf-bg-primary);
          box-shadow: 0 0 0 2px var(--color-sf-bg-primary), 0 0 0 4px var(--color-sf-text-primary), 0 0 0 8px var(--color-sf-bg-primary);
}
...
.e-stepper .e-step-valid.e-step-template.e-step-focus {
  -webkit-box-shadow: 0 0 0 2px var(--color-sf-bg-primary), 0 0 0 4px #057647, 0 0 0 8px var(--color-sf-bg-primary);
          box-shadow: 0 0 0 2px var(--color-sf-bg-primary), 0 0 0 4px #057647, 0 0 0 8px var(--color-sf-bg-primary);
}
...
.e-stepper .e-step-error.e-step-template.e-step-focus {
  -webkit-box-shadow: 0 0 0 2px var(--color-sf-bg-primary), 0 0 0 4px var(--color-sf-border-error), 0 0 0 8px var(--color-sf-bg-primary);
          box-shadow: 0 0 0 2px var(--color-sf-bg-primary), 0 0 0 4px var(--color-sf-border-error), 0 0 0 8px var(--color-sf-bg-primary);
}
...
.e-stepper .e-step-container:not(.e-step-focus).e-step-completed .e-step, .e-stepper.e-steps-focus .e-step-container:not(.e-step-focus).e-step-selected .e-step {
  -webkit-box-shadow: 0 0 0 8px var(--color-sf-bg-primary);
          box-shadow: 0 0 0 8px var(--color-sf-bg-primary);
}
...
.e-stepper .e-step-notstarted:not(.e-step-disabled) .e-indicator:hover {
  border-color: var(--color-sf-border-primary-alt);
}
