...
.e-pager .e-lastpage:hover {
  border-radius: calc(var(--e-radius) * 0) calc(var(--e-radius) * 0.1875) calc(var(--e-radius) * 0.1875) calc(var(--e-radius) * 0);
}
.e-pager .e-firstpage:hover {
  border-radius: calc(var(--e-radius) * 0.1875) calc(var(--e-radius) * 0) calc(var(--e-radius) * 0) calc(var(--e-radius) * 0.1875);
}
...
.e-toolbar .e-toolbar-items {
  border-radius: calc(var(--e-radius) * 0.375) calc(var(--e-radius) * 0) calc(var(--e-radius) * 0) calc(var(--e-radius) * 0.375);
  display: -webkit-inline-box;
  display: -ms-inline-flexbox;
  display: inline-flex;
  height: 100%;
...
.e-toolbar .e-hor-nav {
  -webkit-box-align: center;
      -ms-flex-align: center;
          align-items: center;
  border-radius: calc(var(--e-radius) * 0) calc(var(--e-radius) * 0.375) calc(var(--e-radius) * 0.375) calc(var(--e-radius) * 0);
  cursor: pointer;
  display: -webkit-box;
  display: -ms-flexbox;
  display: flex;
...
.e-toolbar .e-hor-nav.e-nav-active:active, .e-toolbar .e-hor-nav.e-nav-active:focus, .e-toolbar .e-hor-nav.e-nav-active:hover {
  border-bottom-right-radius: calc(var(--e-radius) * 0.5);
}
...
.e-tab .e-tab-header .e-toolbar-item.e-active .e-text-wrap::before {
  ...
  position: absolute;
  width: 100%;
  border-radius: calc(var(--e-radius) * 0.1875) calc(var(--e-radius) * 0.1875) calc(var(--e-radius) * 0) calc(var(--e-radius) * 0);
  bottom: 0;
}
.e-tab .e-tab-header .e-toolbar-item.e-active .e-tab-text,
...
.e-tab .e-tab-header .e-hor-nav:not(.e-expended-nav):focus .e-popup-down-icon:active {
  ...
  border: 0;
  border-radius: calc(var(--e-radius) * 0);
  -webkit-box-shadow: inset 0 1px 2px 0 rgba(var(--color-sf-black), 0.05);
...
.e-bigger .e-treeview .e-list-item.e-editing .e-list-text .e-input-group.e-input-focus .e-input,
.e-treeview.e-bigger .e-list-item.e-editing .e-list-text .e-input-group.e-input-focus .e-input {
  padding-bottom: 8px;
}
...
.e-appbar {
  -webkit-box-shadow: 0 4px 6px -1px rgba(var(--color-sf-black), 0.1), 0 2px 4px -2px rgba(var(--color-sf-black), 0.1);
...
.e-appbar.e-horizontal-bottom {
  -webkit-box-shadow: 0 -4px 6px -1px rgba(var(--color-sf-black), 0.06), 0 -2px 4px -2px rgba(var(--color-sf-black), 0.1);
