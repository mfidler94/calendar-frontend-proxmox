...
.e-schedule .e-schedule-toolbar {
  border: 0;
  border-bottom: 0;
  -webkit-box-shadow: 0 1px 2px rgba(var(--color-sf-base-black), 0.15);
          box-shadow: 0 1px 2px rgba(var(--color-sf-base-black), 0.15);
  margin-bottom: 3px;
  min-height: 38px;
}
...
.e-schedule .e-schedule-toolbar.e-rtl .e-hor-nav:not(.e-nav-active):hover {
  ...
  color: rgba(var(--color-sf-brand-primary), 0.87);
}
...
.e-schedule .e-new-event {
  ...
  border: 1px solid var(--color-sf-on-brand-solid-primary);
  border-radius: 5px;
  height: 100%;
  opacity: 0.9;
  position: relative;
...
.e-schedule .e-vertical-view.e-timescale-disable .e-appointment.e-appointment-border, .e-schedule .e-vertical-view.e-timescale-disable .e-appointment:focus {
  border: 0;
  -webkit-box-shadow: 0 12px 16px -4px rgba(16, 24, 40, 0.08), 0 4px 6px -2px rgba(16, 24, 40, 0.05), 0 12px 16px -4px rgba(16, 24, 40, 0.08), 0 4px 6px -2px rgba(16, 24, 40, 0.05), 0 12px 16px -4px rgba(16, 24, 40, 0.08), 0 4px 6px -2px rgba(16, 24, 40, 0.05);
          box-shadow: 0 12px 16px -4px rgba(16, 24, 40, 0.08), 0 4px 6px -2px rgba(16, 24, 40, 0.05), 0 12px 16px -4px rgba(16, 24, 40, 0.08), 0 4px 6px -2px rgba(16, 24, 40, 0.05), 0 12px 16px -4px rgba(16, 24, 40, 0.08), 0 4px 6px -2px rgba(16, 24, 40, 0.05);
}
...
.e-schedule .e-vertical-view.e-virtual-mask .e-work-cells {
  background: var(--color-sf-bg-secondary);
  -webkit-box-shadow: inset 0 0 0 8px var(--color-sf-bg-primary-alt);
          box-shadow: inset 0 0 0 8px var(--color-sf-bg-primary-alt);
}
...
.e-schedule .e-month-agenda-view .e-content-table {
  ...
  -webkit-box-shadow: 0 1px 0 rgba(var(--color-sf-base-black), 0.15);
          box-shadow: 0 1px 0 rgba(var(--color-sf-base-black), 0.15);
  height: 100%;
}
...
.e-schedule .e-month-agenda-view .e-appointment {
  border-left: 3px solid var(--color-sf-brand-primary);
  border-right: 0;
  cursor: default;
  padding: 0 16px;
}
...
.e-schedule.e-rtl .e-month-agenda-view .e-appointment {
  border-left: 0;
  border-right: 3px solid var(--color-sf-brand-primary);
}
...
.e-schedule.e-multi-drag .e-vertical-view .e-all-day-appointment-wrapper .e-appointment.e-appointment-border, .e-schedule.e-multi-drag .e-vertical-view .e-all-day-appointment-wrapper .e-appointment:focus {
  border: 1px solid rgba(var(--color-sf-border-secondary), 0.5);
}
...
.e-quick-popup-wrapper .e-event-popup .e-popup-header .e-header-icon-wrapper .e-close:hover {
  background: rgba(var(--color-sf-base-white), 0.15);
  color: var(--color-sf-brand-primary);
}
...
.e-quick-popup-wrapper .e-event-popup .e-popup-header .e-subject-wrap .e-subject {
  background: rgba(var(--color-sf-brand-primary), 0.3);
  border-left: 6px solid var(--color-sf-brand-primary);
  border-radius: 4px;
  color: var(--color-sf-text-primary);
  cursor: default;
  font-size: 20px;
...
.e-schedule .e-vertical-view .e-current-timeline {
  border-top: 1px solid var(--color-sf-brand-primary);
}
.e-schedule .e-vertical-view .e-previous-timeline {
  border-top: 1px dotted var(--color-sf-brand-primary);
}
...
.e-tooltip-wrap.e-schedule-error {
  background: var(--color-sf-utility-danger-light);
