...
class Virtualization {
    ...
    setItemContext(item, curData, isHeader) {
        const el = item;
        const existing = (el.context || {});
        el.context = Object.assign({}, existing, { data: curData, nodes: existing.nodes || { flatTemplateNodes: [], groupTemplateNodes: [] }, type: isHeader ? 'groupList' : 'flatList' });
