...
span.e-bigger.e-input-group.e-prepend-wrapper.e-outline.e-float-input.e-control-wrapper label.e-label-bottom {
  top: 18px !important; /* stylelint-disable-line declaration-no-important */
}
...
.e-rating-container .e-rating-item-list .e-rating-item-container.e-rating-selected:active .e-rating-icon, .e-rating-container .e-rating-item-list .e-rating-item-container.e-rating-intermediate:active .e-rating-icon {
  background: -webkit-gradient(linear, left top, right top, from(rgb(13.9642857143, 159.3571428571, 181.5357142857)), to(transparent));
  background: linear-gradient(to right, rgb(13.9642857143, 159.3571428571, 181.5357142857) var(--rating-value), transparent var(--rating-value));
  background-clip: text;
  /* stylelint-disable property-no-vendor-prefix */
  -webkit-background-clip: text;
  /* stylelint-enable property-no-vendor-prefix */
  -webkit-text-stroke: 1px rgb(13.9642857143, 159.3571428571, 181.5357142857);
}
...
.e-rating-container.e-rtl .e-rating-item-list .e-rating-item-container.e-rating-selected:active .e-rating-icon, .e-rating-container.e-rtl .e-rating-item-list .e-rating-item-container.e-rating-intermediate:active .e-rating-icon {
  background: -webkit-gradient(linear, right top, left top, from(rgb(13.9642857143, 159.3571428571, 181.5357142857)), to(transparent));
  background: linear-gradient(to left, rgb(13.9642857143, 159.3571428571, 181.5357142857) var(--rating-value), transparent var(--rating-value));
  background-clip: text;
  /* stylelint-disable property-no-vendor-prefix */
  -webkit-background-clip: text;
  /* stylelint-enable property-no-vendor-prefix */
...
.smart-textarea-suggestion-overlay {
  background-color: rgb(27.323255814, 36.1372093023, 48.476744186);
  color: #fff;
  -webkit-box-shadow: 0 1.25px 4px 0 0 10px 15px -3px rgba(0, 0, 0, 0.1), 0 4px 6px -2px rgba(0, 0, 0, 0.05);
          box-shadow: 0 1.25px 4px 0 0 10px 15px -3px rgba(0, 0, 0, 0.1), 0 4px 6px -2px rgba(0, 0, 0, 0.05);
}
