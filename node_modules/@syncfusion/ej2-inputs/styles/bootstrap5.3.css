...
.e-input-group.e-control-wrapper:not(.e-disabled) .e-input-group-icon:hover {
  color: var(--color-sf-close-icon-color-hover);
}
...
.e-input-group.e-control-wrapper:not(.e-disabled):active:not(.e-success):not(.e-warning).e-error {
  -webkit-box-shadow: 0 0 0 4px rgba(var(--color-sf-danger), 0.25);
  box-shadow: 0 0 0 4px rgba(var(--color-sf-danger), 0.25);
}
...
.e-float-input.e-control-wrapper:not(.e-error):not(.e-warning).e-success:not(.e-input-group).e-input-focus input {
  -webkit-box-shadow: 0 0 0 4px rgba(var(--color-sf-success), 0.25);
  box-shadow: 0 0 0 4px rgba(var(--color-sf-success), 0.25);
}
...
.e-input-group.e-control-wrapper:not(.e-disabled):active:not(.e-success):not(.e-error).e-warning {
  -webkit-box-shadow: 0 0 0 4px rgba(var(--color-sf-warning), 0.25);
  box-shadow: 0 0 0 4px rgba(var(--color-sf-warning), 0.25);
}
...
span.e-bigger.e-input-group.e-prepend-wrapper.e-outline.e-float-input.e-control-wrapper label.e-label-bottom {
  top: 21px !important; /* stylelint-disable-line declaration-no-important */
}
...
.e-container .e-hsv-container .e-handler {
  border: 1px solid rgba(var(--color-sf-white));
  border-radius: calc(var(--e-radius) * 0.375);
  -webkit-box-shadow: 0 0 3px rgba(var(--color-sf-black), 0.7), inset 0 0 2px rgba(var(--color-sf-black), 0.7);
          box-shadow: 0 0 3px rgba(var(--color-sf-black), 0.7), inset 0 0 2px rgba(var(--color-sf-black), 0.7);
  cursor: pointer;
  display: inline-block;
  height: 8px;
  margin-left: -4px;
...
.e-container .e-slider-preview .e-colorpicker-slider .e-slider.e-hue-slider .e-handle, .e-container .e-slider-preview .e-colorpicker-slider .e-slider.e-hue-slider .e-handle-start, .e-container .e-slider-preview .e-colorpicker-slider .e-slider.e-opacity-slider .e-handle, .e-container .e-slider-preview .e-colorpicker-slider .e-slider.e-opacity-slider .e-handle-start {
  -webkit-box-shadow: 0 1px 2px rgba(var(--color-sf-black), 0.3);
          box-shadow: 0 1px 2px rgba(var(--color-sf-black), 0.3);
}
...
.e-bigger .e-container.e-color-palette .e-mode-switch-btn {
  width: 13.306%;
}
...
.e-rating-container .e-rating-item-container.e-selected-value .e-rating-icon {
  -webkit-text-stroke: 1px var(--color-sf-rating-unrated-hover-color);
}
.e-rating-container .e-rating-item-list:hover .e-rating-item-container.e-rating-selected .e-rating-icon, .e-rating-container .e-rating-item-list:hover .e-rating-item-container.e-rating-intermediate .e-rating-icon {
  background: -webkit-gradient(linear, left top, right top, from(var(--color-sf-rating-unrated-hover-color)), to(transparent));
  background: linear-gradient(to right, var(--color-sf-rating-unrated-hover-color) var(--rating-value), transparent var(--rating-value));
  background-clip: text;
  /* stylelint-disable property-no-vendor-prefix */
  -webkit-background-clip: text;
  /* stylelint-enable property-no-vendor-prefix */
...
.e-rating-container.e-rtl .e-rating-item-list:hover .e-rating-item-container.e-rating-selected .e-rating-icon, .e-rating-container.e-rtl .e-rating-item-list:hover .e-rating-item-container.e-rating-intermediate .e-rating-icon {
  background: -webkit-gradient(linear, right top, left top, from(var(--color-sf-rating-unrated-hover-color)), to(transparent));
  background: linear-gradient(to left, var(--color-sf-rating-unrated-hover-color) var(--rating-value), transparent var(--rating-value));
  background-clip: text;
  /* stylelint-disable property-no-vendor-prefix */
  -webkit-background-clip: text;
  /* stylelint-enable property-no-vendor-prefix */
