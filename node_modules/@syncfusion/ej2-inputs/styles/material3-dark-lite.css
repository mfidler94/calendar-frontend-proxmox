...
.e-signature.e-control {
  border: calc(var(--e-border) * 0.0625) solid;
}
...
.e-rtl.e-outline.e-float-input.e-control-wrapper label.e-float-text::after {
  border-radius: calc(var(--e-radius) * 0.3125) 0;
  border-right: 0;
  left: -6px;
}
...
.e-outline.e-float-input label.e-float-text::after,
.e-outline.e-float-input.e-control-wrapper label.e-float-text::after {
  border-radius: 0 calc(var(--e-radius) * 0.3125);
...
div.e-numeric.e-input-group.e-prepend-wrapper.e-filled div.e-prepend-template, div.e-numeric.e-input-group.e-append-wrapper.e-filled div.e-prepend-template,
span.e-numeric.e-input-group.e-prepend-wrapper.e-filled div.e-prepend-template,
span.e-numeric.e-input-group.e-append-wrapper.e-filled div.e-prepend-template {
  padding: 18px 8px 8px 0;
}
div.e-numeric.e-input-group.e-prepend-wrapper.e-filled div.e-append-template, div.e-numeric.e-input-group.e-append-wrapper.e-filled div.e-append-template,
span.e-numeric.e-input-group.e-prepend-wrapper.e-filled div.e-append-template,
span.e-numeric.e-input-group.e-append-wrapper.e-filled div.e-append-template {
...
.e-container.e-color-palette .e-clr-pal-rec-wpr .e-palette.e-recent-palette .e-tile {
  ...
  margin: 0 5.5px;
  border: 0.5px solid var(--color-sf-outline-variant);
}
