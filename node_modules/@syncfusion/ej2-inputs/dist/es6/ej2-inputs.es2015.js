import { isNullOrUndefined, createElement, addClass, attributes, removeClass, formatUnit, remove, detach, classList, closest, Component, getValue, setValue, L10n, getUniqueID, Internationalization, EventHandler, Browser, selectAll, compile, select, append, merge, getNumericObject, Property, Event, NotifyPropertyChanges, extend, ChildProperty, setStyleAttribute, SanitizeHtmlHelper, initializeCSPTemplate, Collection, Complex, Base, onIntlChange, KeyboardEvents, Ajax, Animation, rippleEffect, getInstance } from '@syncfusion/ej2-base';
...
(function (Input) {
    ...
    function encodePlaceHolder(placeholder) {
        ...
        const decoded = decodeHtmlEntities(placeholder);
        return decoded;
    }
...
let NumericTextBox = class NumericTextBox extends Component {
    ...
    updatePrependTemplate() {
        this.removePrependTemplate();
        this.createPrependTemplate();
    }
    updateAppendTemplate() {
        this.removeAppendTemplate();
        this.createAppendTemplate();
    }
    templateComplier(iconTemplate) {
        if (iconTemplate) {
            try {
    ...
    createPrependTemplate() {
        if (!isNullOrUndefined(this.prependTemplate)) {
            ...
            const iconTemplateCompiler = this.iconTemplateFunction(null, this, 'template', this.element.id + 'Template', this.isStringTemplate, null, this.prependedElement);
            if (iconTemplateCompiler) {
                const fromElements = [].slice.call(iconTemplateCompiler);
    ...
    createAppendTemplate() {
        if (!isNullOrUndefined(this.appendTemplate)) {
            ...
            const iconTemplateCompiler = this.iconTemplateFunction(null, this, 'template', this.element.id + 'Template', this.isStringTemplate, null, this.appendedElement);
            if (iconTemplateCompiler) {
                const fromElements = [].slice.call(iconTemplateCompiler);
                append(fromElements, this.appendedElement);
            }
            container.classList.add('e-append-wrapper');
            const spinElement = container.querySelector('.e-spin-down');
    ...
    handleFloatLabel() {
        const floatLabelElement = this.container.querySelector('.e-float-text');
    ...
    updateFloatLabelOverflowWidth() {
        const container = this.inputWrapper.container;
        const label = container.querySelector('.e-float-text-overflow') || container.querySelector('.e-float-text');
...
function maskInputFocusHandler(event) {
    ...
    if (this.floatLabelType !== 'Never' && this.inputObj && this.inputObj.container) {
        const label = this.inputObj.container.querySelector('.e-float-text');
        if (label) {
            label.removeAttribute('style');
        }
    }
    const floatLabelElement = this.inputObj.container.querySelector('.e-float-text');
...
let MaskedTextBox = class MaskedTextBox extends Component {
    ...
    createPrependTemplate() {
        if (!isNullOrUndefined(this.prependTemplate)) {
            const container = this.inputObj.container;
            this.prependedElement = this.createElement('div', { className: 'e-prepend-template' });
            this.iconTemplateFunction = this.templateComplier(this.prependTemplate);
            const iconTemplateCompiler = this.iconTemplateFunction(null, this, 'template', this.element.id + 'Template', this.isStringTemplate, null, this.prependedElement);
            if (iconTemplateCompiler) {
...
let Uploader = class Uploader extends Component {
    ...
    clearData(singleUpload) {
        ...
        if (this.isFormUpload() && this.uploadWrapper.querySelector('.' + INPUT_WRAPPER)) {
            const hiddenElement = this.uploadWrapper.querySelector('.' + INPUT_WRAPPER).querySelector('.' + HIDDEN_INPUT);
            if (hiddenElement) {
...
let ColorPicker = class ColorPicker extends Component {
    ...
    createSplitBtn() {
        ...
        if (this.cssClass) {
            const classes = this.cssClass.replace(/\s+/g, ' ').trim().split(' ');
            if (popupEle) {
    ...
    createPreview(parentEle) {
        ...
        let preview = this.createElement('span', { className: 'e-preview ' + CURRENT, attrs: { title: this.l10n.getConstant('CurrentColor') } });
...
let TextBox = class TextBox extends Component {
        ...
        if (this.multiline && this.floatLabelType === 'Auto' && (this.prependTemplate || this.appendTemplate) && typeof window.ResizeObserver !== 'undefined') {
            const resizeObserver = new window.ResizeObserver((entries) => {
                for (const entry of entries) {
                    const floatLabelElement = entry.target && entry.target.parentElement ? entry.target.parentElement.querySelector('.e-float-text.e-label-bottom') : null;
                    if (floatLabelElement && floatLabelElement.classList.contains('e-label-bottom')) {
    ...
    createPrependTemplate() {
        if (!isNullOrUndefined(this.prependTemplate)) {
            const container = this.textboxWrapper.container;
            this.prependedElement = this.createElement('div', { className: 'e-prepend-template' });
            this.iconTemplateFunction = this.templateComplier(this.prependTemplate);
            const iconTemplateCompiler = this.iconTemplateFunction(null, this, 'template', this.element.id + 'Template', this.isStringTemplate, null, this.prependedElement);
            if (iconTemplateCompiler) {
    ...
    handleFloatLabel() {
        const floatLabelElement = this.textboxWrapper.container.querySelector('.e-float-text');
        if (floatLabelElement && this.floatLabelType === 'Auto') {
            setTimeout(function () {
                if (floatLabelElement && this.prependedElement && !this.enableRtl) {
                    floatLabelElement.style.marginLeft = `${this.prependedElement.offsetWidth}px`;
    ...
    focusHandler(args) {
        ...
        if (this.floatLabelType === 'Auto' && (this.prependTemplate || this.appendTemplate)) {
            setTimeout(function () {
                const label = this.textboxWrapper ? this.textboxWrapper.container.querySelector('.e-float-text') : null;
                if (label) {
    ...
    focusOutHandler(args) {
        ...
        if (this.floatLabelType === 'Auto' && (this.prependTemplate || this.appendTemplate)) {
            setTimeout(function () {
                const label = this.textboxWrapper ? this.textboxWrapper.container.querySelector('.e-float-text.e-label-bottom') : null;
                if (label) {
    ...
    keydownHandler(args) {
        const isUndoAction = args.ctrlKey && args.keyCode === 90;
    ...
    addIcon(position, icons) {
        ...
        const container = this.textboxWrapper.container;
        const iconSpan = container.querySelector('span.e-icons');
        const label = container.querySelector('label');
        if (iconSpan && label) {
            const labelWidth = (this.element.parentElement.offsetWidth) - (iconSpan.offsetWidth);
...
let TextArea = class TextArea extends Component {
    ...
    render() {
        ...
        if (this.floatLabelType === 'Auto' && (this.prependTemplate || this.appendTemplate) && typeof window.ResizeObserver !== 'undefined') {
            const resizeObserver = new window.ResizeObserver((entries) => {
                for (const entry of entries) {
                    const floatLabelElement = entry.target && entry.target.parentElement ? entry.target.parentElement.querySelector('.e-float-text') : null;
                    if (floatLabelElement && floatLabelElement.classList.contains('e-label-bottom')) {
                        floatLabelElement.style.width = `${entry.contentRect.width}px`;
                    }
                    else if (floatLabelElement && floatLabelElement.classList.contains('e-label-top')) {
    ...
    createPrependTemplate() {
        if (!isNullOrUndefined(this.prependTemplate)) {
            const container = this.textareaWrapper.container;
            this.prependedElement = this.createElement('div', { className: 'e-prepend-template' });
            this.iconTemplateFn = this.templateComplier(this.prependTemplate);
            const iconTempCompiler = this.iconTemplateFn(null, this, 'template', this.element.id + 'Template', this.isStringTemplate, null, this.prependedElement);
            if (iconTempCompiler) {
                const fromElements = [].slice.call(iconTempCompiler);
                append(fromElements, this.prependedElement);
            }
    ...
    createAppendTemplate() {
        if (!isNullOrUndefined(this.appendTemplate)) {
            ...
            const iconTempCompiler = this.iconTemplateFn(null, this, 'template', this.element.id + 'Template', this.isStringTemplate, null, this.appendedElement);
            if (iconTempCompiler) {
                const fromElements = [].slice.call(iconTempCompiler);
                append(fromElements, this.appendedElement);
            }
    ...
    handleAdornmentDirection(isPropertyChange) {
        const floatLabelElement = this.textareaWrapper.container.querySelector('.e-float-text');
    ...
    focusHandler(args) {
        ...
        if (this.floatLabelType === 'Auto' && (this.prependTemplate || this.appendTemplate)) {
            setTimeout(function () {
                const label = this.textareaWrapper ? this.textareaWrapper.container.querySelector('.e-float-text') : null;
                if (label) {
                    label.style.width = 'auto';
                }
            }.bind(this), 5);
    ...
    onMouseMove() {
        if (this.textareaWrapper.container.style.width !== 'auto') {
            const initialWidth = this.element.style.width;
            setTimeout(() => {
    ...
    updateFloatLabelOverflowWidth() {
        ...
        if (label && calculateWidth && !(this.cssClass && this.cssClass.split(' ').indexOf('e-outline') !== -1) && (!this.prependTemplate || !this.appendTemplate)) {
            ...
            setTimeout(function () {
                const label = container ? container.querySelector('.e-float-text.e-label-bottom') : null;
                if (label) {
...
class InlineSuggestion {
    ...
    constructor(smartTextArea, container, textArea) {
    ...
    accept() {
        const insertedText = this.currentSuggestion;
