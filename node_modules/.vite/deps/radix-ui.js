...
var require_use_sync_external_store_shim_development = __commonJS({
  "node_modules/use-sync-external-store/cjs/use-sync-external-store-shim.development.js"(exports) {
    ...
    (function() {
      ...
      var React42 = require_react(), objectIs = "function" === typeof Object.is ? Object.is : is, useState21 = React42.useState, useEffect25 = React42.useEffect, useLayoutEffect = React42.useLayoutEffect, useDebugValue = React42.useDebugValue, didWarnOld18Alpha = false, didWarnUncachedGetSnapshot = false, shim = "undefined" === typeof window || "undefined" === typeof window.document || "undefined" === typeof window.document.createElement ? useSyncExternalStore$1 : useSyncExternalStore$2;
...
var DialogPortal = (props) => {
  ...
  return (0, import_jsx_runtime5.jsx)(PortalProvider, { scope: __scopeDialog, forceMount, children: React7.Children.map(children, (child) => (0, import_jsx_runtime5.jsx)(Presence, { present: forceMount || context.open, children: (0, import_jsx_runtime5.jsx)(Portal, { asChild: true, container, children: child }) })) });
};
...
function createSlot2(ownerName) {
  ...
  const Slot22 = React8.forwardRef((props, forwardedRef) => {
    ...
    if (slottable) {
      ...
      return (0, import_jsx_runtime6.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children: React8.isValidElement(newElement) ? React8.cloneElement(newElement, void 0, newChildren) : null });
    }
...
var RovingFocusGroup = React13.forwardRef(
  (props, forwardedRef) => {
    return (0, import_jsx_runtime11.jsx)(Collection2.Provider, { scope: props.__scopeRovingFocusGroup, children: (0, import_jsx_runtime11.jsx)(Collection2.Slot, { scope: props.__scopeRovingFocusGroup, children: (0, import_jsx_runtime11.jsx)(RovingFocusGroupImpl, { ...props, ref: forwardedRef }) }) });
  }
);
...
function createSlot3(ownerName) {
  ...
  const Slot22 = React14.forwardRef((props, forwardedRef) => {
    ...
    if (slottable) {
      ...
      return (0, import_jsx_runtime12.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children: React14.isValidElement(newElement) ? React14.cloneElement(newElement, void 0, newChildren) : null });
    }
...
var NavigationMenu = React22.forwardRef(
  (props, forwardedRef) => {
    const {
    ...
    const [navigationMenu, setNavigationMenu] = React22.useState(null);
    const composedRef = useComposedRefs(forwardedRef, (node) => setNavigationMenu(node));
    const direction = useDirection(dir);
    const openTimerRef = React22.useRef(0);
    const closeTimerRef = React22.useRef(0);
    const skipDelayTimerRef = React22.useRef(0);
    const [isOpenDelayed, setIsOpenDelayed] = React22.useState(true);
    const [value, setValue] = useControllableState({
      prop: valueProp,
      onChange: (value2) => {
        const isOpen = value2 !== "";
    ...
    const startCloseTimer = React22.useCallback(() => {
      window.clearTimeout(closeTimerRef.current);
      closeTimerRef.current = window.setTimeout(() => setValue(""), 150);
    }, [setValue]);
    const handleOpen = React22.useCallback(
      (itemValue) => {
        window.clearTimeout(closeTimerRef.current);
        setValue(itemValue);
      },
    ...
    const handleDelayedOpen = React22.useCallback(
      (itemValue) => {
...
var NavigationMenuSub = React22.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopeNavigationMenu,
      value: valueProp,
...
var NavigationMenuProvider = (props) => {
  ...
  const [viewportContent, setViewportContent] = React22.useState(/* @__PURE__ */ new Map());
  const [indicatorTrack, setIndicatorTrack] = React22.useState(null);
  return (0, import_jsx_runtime20.jsx)(
    NavigationMenuProviderImpl,
    {
      ...
      onViewportContentChange: React22.useCallback((contentValue, contentData) => {
        setViewportContent((prevContent) => {
          prevContent.set(contentValue, contentData);
          return new Map(prevContent);
        });
      }, []),
      onViewportContentRemove: React22.useCallback((contentValue) => {
        setViewportContent((prevContent) => {
...
var NavigationMenuList = React22.forwardRef(
  (props, forwardedRef) => {
...
var NavigationMenuItem = React22.forwardRef(
  (props, forwardedRef) => {
    ...
    const focusProxyRef = React22.useRef(null);
    const restoreContentTabOrderRef = React22.useRef(() => {
    });
    const wasEscapeCloseRef = React22.useRef(false);
    const handleContentEntry = React22.useCallback((side = "start") => {
    ...
    const handleContentExit = React22.useCallback(() => {
      if (contentRef.current) {
        const candidates = getTabbableCandidates(contentRef.current);
...
var NavigationMenuTrigger = React22.forwardRef((props, forwardedRef) => {
  ...
  const hasPointerMoveOpenedRef = React22.useRef(false);
  const wasClickCloseRef = React22.useRef(false);
...
var NavigationMenuLink = React22.forwardRef(
  (props, forwardedRef) => {
...
var NavigationMenuIndicator = React22.forwardRef((props, forwardedRef) => {
...
var NavigationMenuIndicatorImpl = React22.forwardRef((props, forwardedRef) => {
  ...
  const [activeTrigger, setActiveTrigger] = React22.useState(
    null
  );
  const [position, setPosition] = React22.useState(null);
...
var NavigationMenuContent = React22.forwardRef((props, forwardedRef) => {
  const { forceMount, ...contentProps } = props;
...
var ViewportContentMounter = React22.forwardRef((props, forwardedRef) => {
  const context = useNavigationMenuContext(CONTENT_NAME10, props.__scopeNavigationMenu);
...
var NavigationMenuContentImpl = React22.forwardRef((props, forwardedRef) => {
  const {
    __scopeNavigationMenu,
    value,
    triggerRef,
  ...
  const getItems = useCollection5(__scopeNavigationMenu);
  const prevMotionAttributeRef = React22.useRef(null);
  ...
  const motionAttribute = React22.useMemo(() => {
    const items = getItems();
...
var NavigationMenuViewport = React22.forwardRef((props, forwardedRef) => {
...
var NavigationMenuViewportImpl = React22.forwardRef((props, forwardedRef) => {
  ...
  const [size, setSize] = React22.useState(null);
...
var FocusGroup = React22.forwardRef(
  (props, forwardedRef) => {
...
var FocusGroupItem = React22.forwardRef(
  (props, forwardedRef) => {
    const { __scopeNavigationMenu, ...groupProps } = props;
...
var OneTimePasswordField = React23.forwardRef(
  function OneTimePasswordFieldImpl({
    ...
    const sanitizeValue = React23.useCallback(
      (value2) => {
    ...
    const controlledValue = React23.useMemo(() => {
    ...
    const validationTypeRef = React23.useRef(validation);
    React23.useEffect(() => {
      if (!validation) {
        return;
      }
    ...
    const hiddenInputRef = React23.useRef(null);
    const userActionRef = React23.useRef(null);
    ...
    const locateForm = React23.useCallback(() => {
      let formElement;
      if (form) {
    ...
    const attemptSubmit = React23.useCallback(() => {
    ...
    const valueRef = React23.useRef(currentValue);
...
var OneTimePasswordFieldHiddenInput = React23.forwardRef(function OneTimePasswordFieldHiddenInput2({ __scopeOneTimePasswordField, ...props }, forwardedRef) {
...
var OneTimePasswordFieldInput = React23.forwardRef(function OneTimePasswordFieldInput2({
  __scopeOneTimePasswordField,
  onInvalidChange,
  index: indexProp,
  ...props
  ...
  const keyboardActionTimeoutRef = React23.useRef(null);
  React23.useEffect(() => {
    return () => {
...
var PasswordToggleField = ({
  ...
  const [inputIdState, setInputIdState] = React24.useState(defaultInputId);
  const inputId = inputIdState ?? defaultInputId;
  const syncInputId = React24.useCallback(
  ...
  const focusState = React24.useRef(INITIAL_FOCUS_STATE);
...
var PasswordToggleFieldInput = React24.forwardRef(
  ({
    __scopePasswordToggleField,
...
var PasswordToggleFieldToggle = React24.forwardRef(
  ({
    __scopePasswordToggleField,
    onClick,
    onPointerDown,
    ...
    const [internalAriaLabel, setInternalAriaLabel] = React24.useState(void 0);
...
var PasswordToggleFieldIcon = React24.forwardRef(
  ({
    __scopePasswordToggleField,
    // @ts-expect-error
    children,
...
function isSlottable4(child) {
  return React25.isValidElement(child) && typeof child.type === "function" && "__radixId" in child.type && child.type.__radixId === SLOTTABLE_IDENTIFIER4;
}
...
var PopoverContentModal = React26.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime24.jsx)(Combination_default, { as: Slot7, allowPinchZoom: true, children: (0, import_jsx_runtime24.jsx)(
      PopoverContentImpl,
      {
        ...props,
        ref: composedRefs,
...
var PopoverArrow = React26.forwardRef(
  (props, forwardedRef) => {
    ...
    const popperScope = usePopperScope3(__scopePopover);
    return (0, import_jsx_runtime24.jsx)(Arrow, { ...popperScope, ...arrowProps, ref: forwardedRef });
  }
);
...
var Progress = React27.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime25.jsx)(ProgressProvider, { scope: __scopeProgress, value, max, children: (0, import_jsx_runtime25.jsx)(
      Primitive.div,
      {
        "aria-valuemax": max,
        "aria-valuemin": 0,
...
var Separator3 = React31.forwardRef((props, forwardedRef) => {
...
var Slider = React32.forwardRef(
  (props, forwardedRef) => {
    ...
    const thumbRefs = React32.useRef(/* @__PURE__ */ new Set());
    const valueIndexToChangeRef = React32.useRef(0);
    ...
    const valuesBeforeSlideStartRef = React32.useRef(values);
    ...
    return (0, import_jsx_runtime30.jsx)(
      SliderProvider,
      {
        ...
        orientation,
        form,
        children: (0, import_jsx_runtime30.jsx)(Collection7.Provider, { scope: props.__scopeSlider, children: (0, import_jsx_runtime30.jsx)(Collection7.Slot, { scope: props.__scopeSlider, children: (0, import_jsx_runtime30.jsx)(
          SliderOrientation,
          {
...
var SliderHorizontal = React32.forwardRef(
  (props, forwardedRef) => {
    const {
      min,
      max,
    ...
    const [slider, setSlider] = React32.useState(null);
    const composedRefs = useComposedRefs(forwardedRef, (node) => setSlider(node));
    const rectRef = React32.useRef(void 0);
    const direction = useDirection(dir);
    const isDirectionLTR = direction === "ltr";
...
var SliderVertical = React32.forwardRef(
  (props, forwardedRef) => {
    const {
      min,
      max,
    ...
    const sliderRef = React32.useRef(null);
...
var SliderImpl = React32.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopeSlider,
      onSlideStart,
...
var SliderTrack = React32.forwardRef(
  (props, forwardedRef) => {
...
var SliderRange = React32.forwardRef(
  (props, forwardedRef) => {
...
var SliderThumb = React32.forwardRef(
  (props, forwardedRef) => {
    const getItems = useCollection7(props.__scopeSlider);
    const [thumb, setThumb] = React32.useState(null);
    const composedRefs = useComposedRefs(forwardedRef, (node) => setThumb(node));
    const index = React32.useMemo(
      () => thumb ? getItems().findIndex((item) => item.ref.current === thumb) : -1,
      [getItems, thumb]
    );
    return (0, import_jsx_runtime30.jsx)(SliderThumbImpl, { ...props, ref: composedRefs, index });
  }
);
var SliderThumbImpl = React32.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime30.jsxs)(
      "span",
      {
        ...
        children: [
          (0, import_jsx_runtime30.jsx)(Collection7.ItemSlot, { scope: props.__scopeSlider, children: (0, import_jsx_runtime30.jsx)(
            Primitive.span,
            {
              role: "slider",
...
var SliderBubbleInput = React32.forwardRef(
...
__export(dist_exports32, {
  Root: () => Slot8,
  Slot: () => Slot8,
  Slottable: () => Slottable6,
  createSlot: () => createSlot5,
  createSlottable: () => createSlottable5
});
...
function createSlot5(ownerName) {
  ...
  const Slot22 = React33.forwardRef((props, forwardedRef) => {
    ...
    if (slottable) {
      ...
      return (0, import_jsx_runtime31.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children: React33.isValidElement(newElement) ? React33.cloneElement(newElement, void 0, newChildren) : null });
    }
...
function isSlottable5(child) {
  return React33.isValidElement(child) && typeof child.type === "function" && "__radixId" in child.type && child.type.__radixId === SLOTTABLE_IDENTIFIER5;
}
...
var ToastProvider = (props) => {
  ...
  return (0, import_jsx_runtime34.jsx)(Collection8.Provider, { scope: __scopeToast, children: (0, import_jsx_runtime34.jsx)(
  ...
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime34.jsxs)(
      Branch,
      {
        ...
        children: [
          hasToasts && (0, import_jsx_runtime34.jsx)(
            FocusProxy,
            {
          ...
          (0, import_jsx_runtime34.jsx)(Collection8.Slot, { scope: __scopeToast, children: (0, import_jsx_runtime34.jsx)(Primitive.ol, { tabIndex: -1, ...viewportProps, ref: composedRefs }) }),
          hasToasts && (0, import_jsx_runtime34.jsx)(
            FocusProxy,
            {
...
var Toast = React36.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime34.jsx)(Presence, { present: forceMount || open, children: (0, import_jsx_runtime34.jsx)(
      ToastImpl,
      {
        open,
        ...toastProps,
...
var ToastImpl = React36.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime34.jsxs)(import_jsx_runtime34.Fragment, { children: [
      announceTextContent && (0, import_jsx_runtime34.jsx)(
        ToastAnnounce,
        {
          __scopeToast,
          role: "status",
      ...
      (0, import_jsx_runtime34.jsx)(ToastInteractiveProvider, { scope: __scopeToast, onClose: handleClose, children: ReactDOM2.createPortal(
        (0, import_jsx_runtime34.jsx)(Collection8.ItemSlot, { scope: __scopeToast, children: (0, import_jsx_runtime34.jsx)(
          Root2,
          {
            asChild: true,
...
var ToastAnnounce = (props) => {
  ...
  return isAnnounced ? null : (0, import_jsx_runtime34.jsx)(Portal, { asChild: true, children: (0, import_jsx_runtime34.jsx)(VisuallyHidden, { ...announceProps, children: renderAnnounceText && (0, import_jsx_runtime34.jsxs)(import_jsx_runtime34.Fragment, { children: [
    context.label,
    " ",
    children
  ] }) }) });
...
var ToastTitle = React36.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime34.jsx)(Primitive.div, { ...titleProps, ref: forwardedRef });
  }
);
...
var ToastDescription = React36.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime34.jsx)(Primitive.div, { ...descriptionProps, ref: forwardedRef });
  }
);
...
var ToastAction = React36.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime34.jsx)(ToastAnnounceExclude, { altText, asChild: true, children: (0, import_jsx_runtime34.jsx)(ToastClose, { ...actionProps, ref: forwardedRef }) });
  }
);
...
var ToastClose = React36.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime34.jsx)(ToastAnnounceExclude, { asChild: true, children: (0, import_jsx_runtime34.jsx)(
      Primitive.button,
      {
        type: "button",
        ...closeProps,
...
var ToggleGroup = import_react2.default.forwardRef((props, forwardedRef) => {
  ...
  if (type === "single") {
    ...
    return (0, import_jsx_runtime36.jsx)(ToggleGroupImplSingle, { ...singleProps, ref: forwardedRef });
  }
  if (type === "multiple") {
    const multipleProps = toggleGroupProps;
    return (0, import_jsx_runtime36.jsx)(ToggleGroupImplMultiple, { ...multipleProps, ref: forwardedRef });
  }
...
var ToggleGroupImplSingle = import_react2.default.forwardRef((props, forwardedRef) => {
  ...
  return (0, import_jsx_runtime36.jsx)(
    ToggleGroupValueProvider,
    {
      ...
      children: (0, import_jsx_runtime36.jsx)(ToggleGroupImpl, { ...toggleGroupSingleProps, ref: forwardedRef })
    }
  );
});
var ToggleGroupImplMultiple = import_react2.default.forwardRef((props, forwardedRef) => {
  ...
  return (0, import_jsx_runtime36.jsx)(
    ToggleGroupValueProvider,
    {
      ...
      children: (0, import_jsx_runtime36.jsx)(ToggleGroupImpl, { ...toggleGroupMultipleProps, ref: forwardedRef })
    }
  );
});
ToggleGroup.displayName = TOGGLE_GROUP_NAME;
...
var ToggleGroupImpl = import_react2.default.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime36.jsx)(ToggleGroupContext, { scope: __scopeToggleGroup, rovingFocus, disabled, children: rovingFocus ? (0, import_jsx_runtime36.jsx)(
      Root8,
      {
        asChild: true,
        ...rovingFocusGroupScope,
        ...
        dir: direction,
        loop,
        children: (0, import_jsx_runtime36.jsx)(Primitive.div, { ...commonProps, ref: forwardedRef })
      }
    ) : (0, import_jsx_runtime36.jsx)(Primitive.div, { ...commonProps, ref: forwardedRef }) });
  }
);
...
var ToggleGroupItem = import_react2.default.forwardRef(
  (props, forwardedRef) => {
    ...
    return context.rovingFocus ? (0, import_jsx_runtime36.jsx)(
      Item2,
      {
        asChild: true,
        ...rovingFocusGroupScope,
        ...
        active: pressed,
        ref,
        children: (0, import_jsx_runtime36.jsx)(ToggleGroupItemImpl, { ...commonProps, ref: forwardedRef })
      }
    ) : (0, import_jsx_runtime36.jsx)(ToggleGroupItemImpl, { ...commonProps, ref: forwardedRef });
  }
);
...
function createSlot6(ownerName) {
  ...
  const Slot22 = React40.forwardRef((props, forwardedRef) => {
    ...
    if (slottable) {
      ...
      return (0, import_jsx_runtime38.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children: React40.isValidElement(newElement) ? React40.cloneElement(newElement, void 0, newChildren) : null });
    }
...
function isSlottable6(child) {
  return React40.isValidElement(child) && typeof child.type === "function" && "__radixId" in child.type && child.type.__radixId === SLOTTABLE_IDENTIFIER6;
}
...
var Slottable8 = createSlottable6("TooltipContent");
      ...
      DismissableLayer,
      {
        ...
        children: (0, import_jsx_runtime39.jsxs)(
          Content,
          {
            ...
            children: [
              (0, import_jsx_runtime39.jsx)(Slottable8, { children }),
              (0, import_jsx_runtime39.jsx)(VisuallyHiddenContentContextProvider, { scope: __scopeTooltip, isInside: true, children: (0, import_jsx_runtime39.jsx)(Root3, { id: context.contentId, role: "tooltip", children: ariaLabel || children }) })
            ]
          }
        )
      }
...
export {
  ...
  dist_exports19 as Form,
  dist_exports20 as HoverCard,
